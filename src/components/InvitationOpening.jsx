      ...
      {!opening && (
        ...
        >
          ...
          <div className="relative z-10 flex w-full max-w-3xl flex-col items-center px-6">
            ...
            {/* ENVELOPE AREA */}
            <div
              className="relative h-[245px] w-full max-w-[540px] sm:h-[305px]"
            ...
            >
              <motion.button
                type="button"
                onClick={handleOpen}
                className="text-[9px] font-medium uppercase tracking-[0.48em] text-white/70 transition-colors hover:text-white sm:text-[10px]"
              >
